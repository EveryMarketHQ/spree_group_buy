...
function CartForm($, $cartForm) {
  ...
  this.bindEventHandlers = function() {
    ...
    $cartForm.on('click', GROUP_BUY_SELECTOR, this.handleGroupBuyValueClick)
  }
  ...
  this.handleGroupBuyValueClick = function(event) {
    group_buy_id = $(event.currentTarget).val()
    group_buy_price = $(event.currentTarget).data('price')
    group_buy_display_price = $(event.currentTarget).data('display-price')
  }.bind(this)
